...
| LLM (/v1*, OpenAI style) | Management (/api/*) |
|---|---|
| ```json
...
- Console/Dashboard: <https://api.bluesminds.com/console>
- Model Marketplace: <https://api.bluesminds.com/#/model-marketplace>
- Community (Telegram): <https://t.me/apibluesminds>
- Platform repo: <https://github.com/QuantumNous/new-api>
